  ...
  return {
    ...
    operations: o
      ? {
          ...
          delayed: o.delayed,
          onHold: o.onHold,
          unknownOrUnmappedStatus: o.unknownStatus,
          commercialOnlyStatus: o.commercialOnlyStatus,
          executionDataAvailable: o.executionDataAvailable,
          delayDeterminableCount: o.delayDeterminableCount,
          statusSemanticsCaveats: o.semanticsCaveats,
          averageCompletion: o.averageCompletion,
          completionSampleSize: o.completionSampleSize,
          totalValue: o.totalValue,
          bySector: o.bySector.slice(0, 8),
          byRawStatus: o.byRawStatus.slice(0, 12),
          byOperationalStatus: o.byOperationalStatus.slice(0, 8),
          byCommercialStatus: o.byCommercialStatus.slice(0, 8),
